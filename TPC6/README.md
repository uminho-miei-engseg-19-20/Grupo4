...
**[CWE-416: Use After Free](https://cwe.mitre.org/data/definitions/416.html)** (*Rank* 7)
...
### Pergunta 1.2
#### 1.
Valores de *SLOC* segundo o *website* [Information is beautiful](https://informationisbeautiful.net/visualizations/million-lines-of-code/):
- *Facebook:* 62 milhões SLOC
- *Linux 3.1:* 15 milhões SLOC
- *Software* de automóveis: 100 milhões SLOC
- Todos os serviços Internet da *Google*: 2 mil milhões SLOC

Estimativa de bugs:
- *Facebook:* entre 310 mil e 3 100 mil bugs
- *Linux 3.1:* entre 75 mil e 750 mil bugs
- *Software* de automóveis: entre 500 mil e 5 000 mil bugs
- Todos os serviços Internet da *Google*: entre 10 milhões  e 100 milhões bugs

Nota: O limite inferior correspondem a calculo para *software* desenvolvido utilizando métodos de desenvolvimento rigorosos e o limite superior para *software* normal. Desta forma conseguimos um intervalo para a estimativa do número de bugs.

#### 2.
Não é possível, a partir dos bugs calculados anteriormente, estimar o número de vulnerabilidades.
